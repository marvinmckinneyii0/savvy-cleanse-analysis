...
Story 1.1 installs the logging hook. The config schema is defined in
Story 2.1 — see :mod:`backend.models.pipeline_config`, where
:class:`PipelineConfig` and its sub-models live alongside the other
Pydantic contracts. It is re-exported here so the historical import path
