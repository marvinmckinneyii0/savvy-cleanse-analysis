...
Story 1.1 installed the logging hooks below. The config schema is defined
in Story 2.1 — see :mod:`backend.models.pipeline_config`, where the
Pydantic contract lives alongside the other model-layer contracts.
:class:`PipelineConfig` is re-exported here so the historical import path
