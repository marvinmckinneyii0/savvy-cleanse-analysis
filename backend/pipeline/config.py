...
Story 1.1 installed the logging hook here. The config schema is defined
in Story 2.1; see :mod:`backend.models.pipeline_config` for the Pydantic
contract (``PipelineConfig`` and friends). This module re-exports
:class:`PipelineConfig` so the historical import path
