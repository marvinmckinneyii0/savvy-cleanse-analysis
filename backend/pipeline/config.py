...
Story 1.1 installed the logging hook; the config schema was defined in
Story 2.1 — see :mod:`backend.models.pipeline_config`, where the Pydantic
contract lives alongside the other pipeline models. :class:`PipelineConfig`
is re-exported here so the historical import path
